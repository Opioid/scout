...
func (disk *Disk) Intersect(transformation *math.ComposedTransformation, ray, tray *math.OptimizedRay,
...
func (disk *Disk) IntersectP(transformation *math.ComposedTransformation, ray, tray *math.OptimizedRay,
